...
<html lang="fr">
    ...
    <body>
        <div class="conteneur-conn">
            <h1 class="text-center blue">Connexion - Monitoring CISCO</h1>
            <div class="separator"></div>
            <div class="connexionDiv">
                <form method="post">
                    <label for="id">Identifiant</label>
                    <input type="text" name="id" placeholder="Identifiant CISCO">
                    <label for="id">Mot de passe</label>
                    <input type="text" name="id" placeholder="Mot de passe CISCO">
                </form>
            </div>
        </div>
