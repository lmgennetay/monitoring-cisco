        ...
        <div class="conteneur">
            ...
            <div class="portsCommandeFlex">
                <div class="rechercheCommande">
                    <label for="commandeLine">Liste des commandes</label>
                ...
                <div class="paramCommande">
                    ...
                    <textarea disabled id="result" name="story" rows="5" cols="33" class="infoTextarea"><?php if(isset($output)) { echo $output; } ?>
                    </textarea>
                </div>
            </div>
        </div>
